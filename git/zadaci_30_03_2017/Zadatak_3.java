...
public class Zadatak_3 {
	...
	public static void main(String[] args) {
		 ...
		 * and implement the compareTo method to compare the circles on the
		 * basis of area. Write a test class to find the larger of two instances
		 * of ComparableCircle objects.
		 */
		
		ComparableCircle comparableCircle1 = new ComparableCircle(18.28);
