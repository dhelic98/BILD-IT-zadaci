...
public class Zadatak_1 {
	...
	public static void main(String[] args) {
		 ...
		 * follows: private long[] r = new long[2]; Use r[0] to represent the
		 * numerator and r[1] to represent the denominator. The signatures of
		 * the methods in the Rational class are not changed, so a client
