...
public class BigIntRational extends Number implements Comparable {
	...
	public boolean equals(Object other) {
		if (((this.subtract((BigIntRational) (other))).getNumerator())
	...
	public int compareTo(Object o) {
		...
		BigInteger n = this.subtract((BigIntRational) o).getNumerator();
